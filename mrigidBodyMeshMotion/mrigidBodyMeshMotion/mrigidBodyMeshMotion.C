...
#include "mrigidBodyMeshMotion.H"
...
namespace Foam
{
    defineTypeNameAndDebug(mrigidBodyMeshMotion, 0);

    addToRunTimeSelectionTable
    (
        motionSolver,
        mrigidBodyMeshMotion,
        dictionary
    );
}
...
Foam::mrigidBodyMeshMotion::bodyMesh::bodyMesh
(
    const polyMesh& mesh,
    const word& name,
    const label bodyID,
...
Foam::mrigidBodyMeshMotion::mrigidBodyMeshMotion
(
    const polyMesh& mesh,
    ...
    bodyIdCofG_(coeffDict().getOrDefault<label>("bodyIdCofG", -1))
{
   ...
   const dictionary& bodiesDict = coeffDict().subDict("mbodies"); 
...
Foam::mrigidBodyMeshMotion::curPoints() const
{
...
void Foam::mrigidBodyMeshMotion::solve()
{
...
bool Foam::mrigidBodyMeshMotion::writeObject
(
...
bool Foam::mrigidBodyMeshMotion::read()
{
