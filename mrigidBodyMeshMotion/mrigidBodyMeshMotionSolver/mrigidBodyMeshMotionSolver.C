...
#include "mrigidBodyMeshMotionSolver.H"
...
namespace Foam
{
    defineTypeNameAndDebug(mrigidBodyMeshMotionSolver, 0);

    addToRunTimeSelectionTable
    (
        motionSolver,
        mrigidBodyMeshMotionSolver,
        dictionary
    );
}
...
Foam::mrigidBodyMeshMotionSolver::bodyMesh::bodyMesh
(
    const polyMesh& mesh,
    const word& name,
    const label bodyID,
...
Foam::mrigidBodyMeshMotionSolver::mrigidBodyMeshMotionSolver
(
    const polyMesh& mesh,
...
Foam::mrigidBodyMeshMotionSolver::curPoints() const
{
    return meshSolverPtr_->curPoints();
}


void Foam::mrigidBodyMeshMotionSolver::solve()
{
...
bool Foam::mrigidBodyMeshMotionSolver::writeObject
(
...
bool Foam::mrigidBodyMeshMotionSolver::read()
{
...
void Foam::mrigidBodyMeshMotionSolver::movePoints(const pointField& points)
{
    meshSolverPtr_->movePoints(points);
}


void Foam::mrigidBodyMeshMotionSolver::updateMesh(const mapPolyMesh& mpm)
{
