...
namespace mjoints
{
    defineTypeNameAndDebug(mRxyz, 0);
...
Foam::RBD::mjoints::mRxyz::mRxyz(const dictionary& dict)
:
    mjoint(3)
{
    S_[0] = spatialVector(1, 0, 0, 0, 0, 0);
...
Foam::autoPtr<Foam::RBD::mjoint> Foam::RBD::mjoints::mRxyz::clone() const
{
    return autoPtr<mjoint>(new mRxyz(*this));
}
...
void Foam::RBD::mjoints::mRxyz::jcalc
(
    mjoint::XSvc& J,
    const scalarField& q,
