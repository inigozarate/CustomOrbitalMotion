...
namespace mjoints
{
    defineTypeNameAndDebug(mRzyx, 0);
...
Foam::RBD::mjoints::mRzyx::mRzyx(const dictionary& dict)
:
    mjoint(3)
{
    S_[0] = spatialVector(0, 0, 1, 0, 0, 0);
...
Foam::autoPtr<Foam::RBD::mjoint> Foam::RBD::mjoints::mRzyx::clone() const
{
    return autoPtr<mjoint>(new mRzyx(*this));
}
...
void Foam::RBD::mjoints::mRzyx::jcalc
(
    mjoint::XSvc& J,
    const scalarField& q,
