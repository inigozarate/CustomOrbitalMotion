...
namespace mjoints
{
    defineTypeNameAndDebug(mRyxz, 0);
...
Foam::RBD::mjoints::mRyxz::mRyxz(const dictionary& dict)
:
    mjoint(3)
{
    S_[0] = spatialVector(0, 1, 0, 0, 0, 0);
...
Foam::autoPtr<Foam::RBD::mjoint> Foam::RBD::mjoints::mRyxz::clone() const
{
    return autoPtr<mjoint>(new mRyxz(*this));
}
...
void Foam::RBD::mjoints::mRyxz::jcalc
(
    mjoint::XSvc& J,
    const scalarField& q,
